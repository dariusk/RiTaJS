 ...
 *  RiTa:
    ...
    Add: RiHTMLParser / Google Search / MsNgramClient
        ...
        $Id: rita.-backup.12:04.js,v 1.1 2012/06/19 16:07:45 dev Exp $

 */
(function(window, undefined) {
    
    /**
     * Simple type-checking framework 
    ...
    RiMarkov.prototype = {
        ...
        /**
         * @constructor Construct a Markov chain (or n-gram) model 
     ...
     * <p>A typical usage might be to switch on the type 
     * of a RiTaEvent within a callback:<pre>
        function onRiTaEvent(e)
        {
          if (e.type() == RiTa.BEHAVIOR_COMPLETED)
            ...
          else 
               ...
    ...
    RiTaEvent.prototype = {
        ...
        constructs : function(sourceRiText, eventType) //, data) {
        {
    ...
    RiLexicon.prototype = {
        ...
        /**
         * @constructor Constructs an instance of the RiLexicon class. 
     ...
     * additional functionality for the basic javascript string
     */
    RiString = makeClass();
    ...
    RiString.prototype = {
        ...
        /**
         * @constructor The RiString constructor function
        ...
        pos : function() {
            ...
            var words = RiTa.tokenize(trim(this._text)); // was getPlaintext()
        ...
        wordAt : function(index) {
            ...
            var words = RiTa.tokenize(trim(this._text));
        ...
        insertWordAt : function(newWord, wordIdx) {
            ...
            if (newWord && newWord.length && wordIdx >= 0 && wordIdx < words.length) {
                ...
                this.text(joinWords(words)).replaceAll(DeLiM,E);
            }
         ...
         * 
         * @param {string} substr (Required) string the prefix
         ...
         * 
         * @param {number} start (required) The index where to start the extraction. First character is at
         *        index 0
         ...
         * 
         * @param {number} from (required) The index where to start the extraction. First character is at
         *        index 0
    ...
    RiGrammar.prototype = {
        ...
        /**
         * @constructor Initializes a grammar from an object or JSON string containing the rules
         * 
        ...
        clone : function() { // TODO: test me well
          ...
          for (var name in this._rules) {
              tmp.rules[name] = this._rules[name];
          }
          return tmp;
        ...
        getRule : function(pre) {
            ...
            if (cnt == 1) {
                ...
                var sr = this.__getStochasticRule(tmp);
        ...
        __getStochasticRule : function(temp)    { // map
     
            var dbug = false;
            
            if (dbug) log("__getStochasticRule(" + temp + ")");
...
//    
    ...
    RiText.prototype = {
        ...
        constructs : function(text, x, y, font) { 
            ...
            //log('RiText) '+this._rs.text +" / "+ this._font.name);
...
//        },
        ...
        textTo: function(newText, seconds, endAlpha, callback) {
          ...
          return this.colorTo(c.r, c.g, c.b, endAlpha, seconds * .95, 0, 'fadeToText');
        },
...
//          * according to the RiTexts current matrix
    ...
    RiTa = {
         ...
         * @returns {boolean} true if 'sentence' starts with a question sword.
         */
        ...
        getPhonemes : function(words) {
            ...
            return RiLexicon.getPhonemes(words);
        ...
        getStresses : function(words) {
            ...
            return RiLexicon.getStresses(words);
        ...
        getSyllables : function(words) {
            ...
            return RiLexicon.getSyllables(words);
    ...
    */
    ...
    var SP = " ", N = 'number', S = 'string', O = 'object', A ='array', B = 'boolean', R = 'regexp', E = "";
